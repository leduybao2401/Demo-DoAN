            ...
            <div class="card " style="">
                <div class="card-header bg-primary">
                    <h3 class="text-white">Order View 
                        <a href="{{ url('my-order', []) }}" class="btn btn-outline-warning text-yl float-end "><i class="fa-solid fa-backward"></i> Back</a>
                    </h3>
                </div>
                <div class="card-body">
                    <div class="row">
                                ...
                                <tbody>
                                    ...
                                    {{-- orderitem.model.order.function --}}
                                        <tr>
                                            ...
                                            <td>{{$item->price}}</td>
                                            <td>
                                                <img src="{{ asset('assets/uploads/products/' . $item->product->image) }}" width="50px" alt="hear">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
